  ...
  <div class='shopping-cart'>
    ...
    <div class="flex" style="height: 100%">
      <div class="cart">
        ...
        <div @click="isBoughtList = !isBoughtList" class="cart-container" :class="totalPrice > 0 ? 'cart-img__actived' : 'cart-img__active'"></div>
      </div>
      <div class="good-cost">
        <p>￥{{totalPrice}}</p>
      </div>
      <div class="btn-box">
        <button class="btn-buy" @click="payCost()" :class="totalPrice > 0 ? 'btn-buy-active' : ''">去结算</button>
      </div>
    </div>
  </div>
</template>
